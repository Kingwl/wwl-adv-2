...
| UI-BOARD-001 | 主棋盘和地图 | 地图加载、道路可见、棋盘缩放后坐标映射正确、敌人/塔/血条/攻击反馈可见。 | GUT 覆盖地图资源、默认路径、坐标映射、放置、敌人生成和攻击反馈；native smoke 覆盖一次放塔和敌人生成。 | 整屏 smoke 截图。 | 没有棋盘局部 overlay；如果棋盘 UI 元素增多再补。 |
