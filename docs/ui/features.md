...
- 逐塔视觉目录：`tower_visual_catalog` 场景从塔配置自动发现每个 `visual_test_enabled` 塔，并分别生成 `*-tower-ready`、`*-projectile-visible` 和 `*-impact-effect` checkpoint。
